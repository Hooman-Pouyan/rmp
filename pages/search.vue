...
<UsaAccordion bordered class="mt-4 mb-6">
  ...
  <UsaAccordionItem label="User Guide">
    ...
    <ul class="list-disc ml-6">
      ...
      <li>Searching in the “Advanced” section by chemical name or NAICS code to find facilities regulated for a specific chemical or industry code.</li>
    ...
    <p>
      For additional details on what makes an incident reportable, see <a href="https://www.whatsinmyair.org/data-liberation-project/rmp/what-counts-as-an-accident" target="_blank" rel="noopener noreferrer">“What counts as an accident?” by Data Liberation Project</a>.
    </p>
